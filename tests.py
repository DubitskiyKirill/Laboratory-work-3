...
class TestStringMethods(unittest.TestCase):
    ...
    def test_konvert_type_1_1(self):#Проверка 
        tester = app.test_client(self)  # создаем клиент для тестирования
    ...
    def test_konvert_type_1_2(self):  # Второй тест работоспособности первого режима
        tester = app.test_client(self)  # создаем клиент для тестирования
    ...
    def test_konvert_type_2_1(self):  # Первый тест работоспособности второго режима
        tester = app.test_client(self)  # создаем клиент для тестирования
    ...
    def test_konvert_type_2_2(self):  # Второй тест работоспособности второго режима
        tester = app.test_client(self)  # создаем клиент для тестирования
